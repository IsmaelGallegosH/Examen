...
@section('content')
        <form action="{{route('producto.update')}}" method="post" class="form-horizontal">
            @csrf   
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" name="costo" value="{{$producto->costo}}" required>
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" name="descripcion" rows="3">{{$producto->descripcion}}</textarea>
              </div>
