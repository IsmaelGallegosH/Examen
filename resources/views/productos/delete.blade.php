...
@section('content')
        <form action="{{route('producto.destroy')}}" method="post" class="form-horizontal">
            @csrf   
            <div class="form-group">
                <label for="disabledTextInput">ID</label>
                <input type="text" id="disabledTextInput" class="form-control" name="upc" value="{{$producto->upc}}" readonly >
              </div>

            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputEmail4">Costo</label>
                    <input type="number" class="form-control" name="costo" value="{{$producto->costo}}" readonly >
                </div>
                <div class="form-group col-md-6">
